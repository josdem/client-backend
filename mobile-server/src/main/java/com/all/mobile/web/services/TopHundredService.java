...
public class TopHundredService {
	...
	public List<Category> getCategories() {
		return hibernateTemplate.executeFind(new HibernateCallback<List<Category>>(){
			@Override
	...
	@SuppressWarnings("unchecked")
	public List<MobileTrack> getTopPlaylistTracks(final String topPlaylistId) {
		return hibernateTemplate.executeFind(new HibernateCallback<List<MobileTrack>>() {
			@Override
			public List<MobileTrack> doInHibernate(Session session) throws HibernateException, SQLException {
				Query query = session
						.createQuery("Select mt From MobileTrack mt, TopPlaylistTrack tpt where tpt.playlist=:topPlaylistId and tpt.track=mt.hashcode order by tpt.numTrack");
