...
public class WidgetDao {
	...
	public Long save(final WidgetContent content) {
		return (Long) hibernate.save(content);
//		return hibernate.execute(new HibernateCallback<Long>() {
//			@Override
//			public Long doInHibernate(Session session) throws HibernateException, SQLException {
//				return (Long) session.save(content);
//			}
//		});
	}
