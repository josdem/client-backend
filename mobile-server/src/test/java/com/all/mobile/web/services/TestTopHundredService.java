...
import com.all.mobile.web.model.Category;
import com.all.mobile.web.model.MobileTrack;
import com.all.mobile.web.model.TopPlaylist;

public class TestTopHundredService {

	@InjectMocks
	private TopHundredService service = new TopHundredService();
	@Mock
	...
	@Test
	public void shouldGetCategoriesFromDB() throws Exception {
	...
	@SuppressWarnings("unchecked")
	@Test
	public void shouldReturnTracksForTopPlaylist() throws Exception {
		String topPlaylistId = "topPlaylistId";
		
		service.getTopPlaylistTracks(topPlaylistId);
		...
		Query query = mock(Query.class);
		when(session.createQuery(anyString())).thenReturn(query);
		List expected = new ArrayList<MobileTrack>();
		when(query.list()).thenReturn(expected);
		List<MobileTrack> actual = (List<MobileTrack>) callback.doInHibernate(session);
		
		assertEquals(expected, actual);
		verify(query).setParameter("topPlaylistId", topPlaylistId);
	}
}
