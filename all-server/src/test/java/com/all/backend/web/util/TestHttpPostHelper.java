...
import com.all.backend.web.util.HttpPostHelper;


public class TestHttpPostHelper {
	HttpPostHelper httpPostHelper = new HttpPostHelper();
	private String expectedPost = "http://192.168.1.2/openinviter/retrieveContacts.php?email=joseluisdelacruzmorales@hotmail.com&password=passwd&provider=hotmail";
